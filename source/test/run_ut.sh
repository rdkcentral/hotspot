...
log "INFO" "Running make for Gtest folders..."
...
if [ -f "./source/test/HotspotApiTest/HotspotApi_gtest.bin" ]; then
    log "INFO" "Running HotspotApi_gtest.bin"
    ./source/test/HotspotApiTest/HotspotApi_gtest.bin
    log "INFO" "Completed Test Execution of HotspotApi_gtest.bin"
else
    log "ERROR" "HotspotApi_gtest.bin does not exist, cannot run tests"
    exit 1
fi

if [ -f "./source/test/HotspotFdTest/HotspotFd_gtest.bin" ]; then
    log "INFO" "Running HotspotFd_gtest.bin"
    ./source/test/HotspotFdTest/HotspotFd_gtest.bin
    log "INFO" "Completed Test Execution of HotspotFd_gtest.bin"
else
    log "ERROR" "HotspotFd_gtest.bin does not exist, cannot run tests"
    exit 1
fi
